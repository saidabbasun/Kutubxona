...
export default class Carusel extends Component {
    ...
    render() {
     const listItem=[
        ...
        {id:1, img: Book , title:"300 грн",bookName:"Порядок в Хаосе",text:"ПКонстантин Коптелов"},
        {id:1, img: Book , title:"300 грн",bookName:"Порядок в Хаосе",text:"ПКонстантин Коптелов"},
        var{id:1, img: Book , title:"300 грн",bookName:"Порядок в Хаосе",text:"ПКонстантин Коптелов"},
        <var><var>{id:1, img: Book , title:"300 грн",bookName:"Порядок в Хаосе",text:"ПКонстантин Коптелов"},</var></var>
      ]
      const settings = {
        dots: false,
