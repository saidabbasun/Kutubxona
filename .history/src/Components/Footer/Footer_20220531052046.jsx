  ...
  return (
    <div className='Footer'>
       ...
       <div className='footerNavMenu'>
           {/* <p>hdccccccccccccccccccccccccccccccccccccccccccccchwehhhbhwbeb</p> */}
        <ul className="navbarNav ">
      <li className="navItem active">
        <a className="navLink" href="#">Акции </a>
      </li>
      <li className="nav-item">
        <a className="navink" href="#">Каталлог</a>
      </li>
      <li className="nav-item ">
        <a className="navink" href="#">Доставка </a>
      </li>
      <li className="navtem">
        <a className="navink" href="#">О магазине</a>
      </li>
    
      <li className="nav-item">
        <a className="navink " href="#">Блог</a>
      </li>
    </ul> 
        </div>
      {/* <div className="List">
