  ...
  return (
    <div className='Footer'>
       ...
       <img src={Logo} alt="" />
        ...
        <ul className="navbar-av ">
      <li className="nav-item ">
        <a className="na-link" href="#">Акции </a>
      </li>
      <li className="nav-item">
        <a className="na-link" href="#">Каталлог</a>
      </li>
      <li className="nav-item ">
        <a className="na-link" href="#">Доставка </a>
      </li>
      <li className="nav-item">
        <a className="na-link" href="#">О магазине</a>
      </li>
    
      <li className="nav-item">
        <a className="na-link " href="#">Блог</a>
      </li>
    </ul> 
