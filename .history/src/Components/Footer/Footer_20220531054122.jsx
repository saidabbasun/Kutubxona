      ...
      <div className="List">
        <ul>
           <a className="link " href="#"> <li>Популярное</li></a>
             <a className="link " href="#"><li>Книги для детей</li><
             <a className="link " href="#"><li> Программирование</li><
             <a className="link " href="#"><li> Психология</li><
             <a className="link " href="#"><li> Бизнес</li><
        </ul>
        <ul>
             <a className="link " href="#"><li>  Доставка  </li><
             <a className="link " href="#"><li>Информация</li><
             <a className="link " href="#"><li> Оплата</li><
             <a className="link " href="#"><li>  O магазине</li><
           
        </ul>
        <ul>
             <a className="link " href="#"><li>Помощь</li><
             <a className="link " href="#"><li>  Контакты</li><
             <a className="link " href="#"><li> Возврат товара</li><
             <a className="link " href="#"><li> Помощь покупателю</li><
