      ...
      <div className="List">
        <ul>
           <a className="link " href="#"> <li>Популярное</li></a>
             < className="link " href="#"><li>Книги для детей</li>
             < className="link " href="#"><li> Программирование</li>
             < className="link " href="#"><li> Психология</li>
             < className="link " href="#"><li> Бизнес</li>
        </ul>
        <ul>
             < className="link " href="#"><li>  Доставка  </li>
             < className="link " href="#"><li>Информация</li>
             < className="link " href="#"><li> Оплата</li>
             < className="link " href="#"><li>  O магазине</li>
           
        </ul>
        <ul>
             < className="link " href="#"><li>Помощь</li>
             < className="link " href="#"><li>  Контакты</li>
             < className="link " href="#"><li> Возврат товара</li>
             < className="link " href="#"><li> Помощь покупателю</li>
